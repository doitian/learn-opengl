...
int main(int argc, char* argv[])
{
  ...
  GLuint program = glCreateProgram();
  {
    ...
    ensureNoErrorMessage("Compiling Vertex Shader", glrShaderSourceFromFile(vertexShader, "shaders/c6-1.vert"));
    ensureNoErrorMessage("Compiling Frag Shader", glrShaderSourceFromFile(fragShader, "shaders/c6-1.frag"));
