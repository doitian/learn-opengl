...
int main(int argc, char *argv[])
{
  ...
  GLuint lightProgram = glCreateProgram();
  {
    ...
    ensureNoErrorMessage("Compiling Frag Shader", glrShaderSourceFromFile(fragShader, "shaders/c14-1.light.frag"));
  ...
  {
    GLuint fragShader = glCreateShader(GL_FRAGMENT_SHADER);
    ensureNoErrorMessage("Compiling Frag Shader", glrShaderSourceFromFile(fragShader, "shaders/c14-1.object.frag"));
