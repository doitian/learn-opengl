...
int main(int argc, char* argv[])
{
  ...
  GLuint program = glCreateProgram();
  {
    ...
    ensureNoErrorMessage("Compiling Vertex Shader", glrShaderSourceFromFile(vertexShader, "shaders/c6-2.vert"));
    ensureNoErrorMessage("Compiling Frag Shader", glrShaderSourceFromFile(fragShader, "shaders/c6-2.frag"));
